...
"""
for i in range(1,7):
    file_path=f'/Users/nathanchen/Downloads/test{i}.png'
    ...
    result_path=f'/Users/nathanchen/Downloads/edge{i}.png'
    cv2.imwrite(result_path, res)

"""
file_path='/Users/nathanchen/Downloads/test3.png'
frame = cv2.imread(file_path)
canny_img = Canny_detector(frame)
min_val = np.min(canny_img)
max_val = np.max(canny_img)
...
frame_gray = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY)
res = np.hstack((frame_gray, canny_img))
result_path='/Users/nathanchen/Downloads/eee1.png'
cv2.imwrite(result_path, res)
